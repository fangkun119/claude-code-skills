...
**列表措辞原则（重要）：**
- **保持完整句式**：列表项应当语法完整，读起来通顺自然，避免支离破碎的短语堆砌
- **主语一致性**：如果列表项共享主语，可在首项明确或每项保持独立完整
- **平行结构**：同类列表项应保持语法结构一致（如都是"名词+解释"结构）
- **过渡自然**：列表项之间应有逻辑关联，可通过结构词（如"...优势"、"...层面"）体现
- **避免机械切割**：不要简单地将长句用破折号分隔，要重新组织为独立的完整表达单元
